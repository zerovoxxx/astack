...
>
> **评审归档：** 旧 review sidecar 已随文档瘦身删除。
>
...
| **PR6** | E2E ≥ 3 scenario + 文档最终状态刷新（AGENTS.md 导航 / INDEX.md 状态 v0.7 → SHIPPED / 历史 BOUNDARIES sidecar 边界移入"历史完成"） | E2E 和文档原子收口；旧 golden-rules / patterns 沉淀由 spec_review / code_review 前置负责，PR6 不承担"新增规则"动作 |
