...
**产出**：spike 跑过/未过的结论与意料外的行为直接记入 §7 变更记录或 retro，不再单独维护 SPIKE 文档。
...
- **PR2**：`docs/asset/design.md § 数据模型`；本文档 `docs/astack/version/Iteration1_SqliteAndMultiRepo_SPEC.md` 的 schema 部分更新为实际 DDL
