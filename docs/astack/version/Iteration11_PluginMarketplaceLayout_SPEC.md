...
>
> **`/code_review` 结论（2026-05-13）：** 三 Phase 全部通过，0 高 / 0 中 / 0 低问题；旧审查 sidecar 已随文档瘦身删除。
...
17. `docs/astack/INDEX.md` 加 v0.12 行（物理序号 11）。**【已完成 — 行已加，状态翻 IMPLEMENTED】**
18. 历史 `BOUNDARIES.md` 曾加 v0.12 章节；该 sidecar 已随文档瘦身删除。**【已完成】**
...
| PR3 | 文档：AGENTS.md "当前活跃迭代" 切换 + INDEX.md 加行 + 历史 BOUNDARIES sidecar 加章节 + 本 spec 标 SHIPPED。 | 文档原子 |
...
- [ ] AGENTS.md / INDEX.md / 历史 BOUNDARIES sidecar 三文件原子更新（PR3）。
