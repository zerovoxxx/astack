...
4. `docs/astack/INDEX.md` / `BOUNDARIES.md` 追加 v0.9 行。
...
本迭代太小，预计**不**产生新黄金法则。若实施/评审中发现"隐藏在菜单里的高频 action" 这类 UX 反模式值得沉淀，再回填至 已删除的历史 `golden-rules.md` 或 已删除的历史 `patterns.md`。
