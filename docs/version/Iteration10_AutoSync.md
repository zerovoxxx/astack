...
- **PR4 — 文档**
  - `docs/version/INDEX.md` 追 v0.11 行
  - `docs/version/BOUNDARIES.md` 同步：补 `repo.auto_sync_cycle_completed` 事件描述、补 `RefreshRepoResponseSchema.skipped_reason` 扩 `auto_sync_in_progress` 条目
